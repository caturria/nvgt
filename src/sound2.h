//TODO: rename to sound.h when complete.
/* sound2.h - sound system implementation header
 *
...
class mixer: public Poco::RefCountedObject {
	public:
		...
		virtual void set_3d_position(float x, float y, float z) = 0;
		virtual Vector3 get_3d_position() = 0;
		...
		virtual unsigned long long get_time_in_frames() = 0;
		virtual unsigned long long get_time_in_milliseconds() = 0;
		virtual unsigned long long get_position() = 0;
